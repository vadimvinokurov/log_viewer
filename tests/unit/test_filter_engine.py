...
class TestBatchMatch:
    """Test batch_match for matching multiple filters against multiple texts at once."""
    ...
    def test_batch_match_plain_multiple_filters_or(self) -> None:
        from log_viewer.core.filter_engine import batch_match
        texts = ["error occurred", "all fine", "timeout hit"]
        filters = [
    ...
    def test_batch_match_mixed_modes(self) -> None:
        from log_viewer.core.filter_engine import batch_match
    ...
    def test_batch_match_empty_filters(self) -> None:
        from log_viewer.core.filter_engine import batch_match
        texts = ["error occurred"]
        result = batch_match(texts, [])
        assert result == {0}
    ...
    def test_batch_match_uses_pre_lowered(self) -> None:
        """When pre_lowered texts are provided, skip re-lowercasing."""
        from log_viewer.core.filter_engine import batch_match
