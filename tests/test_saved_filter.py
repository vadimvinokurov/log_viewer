...
class TestSavedFilterController:
    ...
    def test_get_combined_filter_or_logic(self, tmp_path) -> None:
        ...
        entry_error = LogEntry(
            ...
            category="Test",
            raw_message="This is an error message",
            display_message="This is an error message",
            file_offset=0,
            raw_line="This is an error message"
        )
        entry_warning = LogEntry(
            ...
            category="Test",
            raw_message="This is a warning message",
            display_message="This is a warning message",
            file_offset=100,
            raw_line="This is a warning message"
        )
        entry_info = LogEntry(
            row_index=2,
            timestamp="00:00:02",
            level=LogLevel.MSG,
            category="Test",
            raw_message="This is an info message",
            display_message="This is an info message",
            file_offset=200,
            raw_line="This is an info message"
        )
    ...
    def test_combined_filtering_saved_and_category(self, qtbot, tmp_path) -> None:
        ...
        entries = [
            LogEntry(
                ...
                raw_message="Error in module1",
                display_message="Error in module1",
                file_offset=0,
                raw_line="Error in module1"
            ),
            LogEntry(
                row_index=1,
                timestamp="00:00:01",
                ...
                raw_message="Warning in module2",
                display_message="Warning in module2",
                file_offset=100,
                raw_line="Warning in module2"
            ),
            LogEntry(
                row_index=2,
                timestamp="00:00:02",
                level=LogLevel.MSG,
                category="App.Module1",
                raw_message="Info in module1",
                display_message="Info in module1",
                file_offset=200,
                raw_line="Info in module1"
            ),
        ]
