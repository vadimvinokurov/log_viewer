...
def toggle(self, path: str, enabled: bool) -> None:
    ...
    Ref: [category-checkbox-behavior.md](category-checkbox-behavior.md) §3.1, §3.2
    """
```

**Behavior:** See [category-checkbox-behavior.md](category-checkbox-behavior.md) §3.1-3.4 for detailed cascade rules.
...
def is_category_visible(self, path: str) -> bool:
    ...
    Ref: [category-checkbox-behavior.md](category-checkbox-behavior.md) §6.1.3
...
**Algorithm:** See [category-checkbox-behavior.md](category-checkbox-behavior.md) §6.1.3 for visibility algorithm.
...
|---------|------|---------|
| 1.3 | 2026-03-15 | Fixed version format, cross-references, removed duplicate content |
