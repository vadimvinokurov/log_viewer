...
- Manual file refresh via button
...
|---------|---------------|--------|
| Category Checkbox Behavior | [specs/features/category-checkbox-behavior.md](specs/features/category-checkbox-behavior.md) | v1.2 |
| Filter Engine | [specs/features/filter-engine.md](specs/features/filter-engine.md) | v1.1 |
| Category Tree | [specs/features/category-tree.md](specs/features/category-tree.md) | v1.3 |
| File Management | [specs/features/file-management.md](specs/features/file-management.md) | v1.0 |
| File Association | [specs/features/file-association.md](specs/features/file-association.md) | v1.0 |
| Multi-Instance | [specs/features/multi-window-instance.md](specs/features/multi-window-instance.md) | DRAFT |
| Main Controller | [specs/features/main-controller.md](specs/features/main-controller.md) | v1.0 |
| UI Components | [specs/features/ui-components.md](specs/features/ui-components.md) | v1.4 |
| UI Design System | [specs/features/ui-design-system.md](specs/features/ui-design-system.md) | v1.4 |
| Typography System | [specs/features/typography-system.md](specs/features/typography-system.md) | v2.2 |
| Table Column Alignment | [specs/features/table-column-alignment.md](specs/features/table-column-alignment.md) | v1.2 |
| Table Cell Text Overflow | [specs/features/table-cell-text-overflow.md](specs/features/table-cell-text-overflow.md) | v1.1 |
| Table Unified Styles | [specs/features/table-unified-styles.md](specs/features/table-unified-styles.md) | v1.7 |
| Selection Preservation | [specs/features/selection-preservation.md](specs/features/selection-preservation.md) | v1.1 |
...
| Saved Filters | [specs/features/saved-filters.md](specs/features/saved-filters.md) | READY |
...
Per [specs/global/memory-model.md](specs/global/memory-model.md) (v1.1):
...
Per [specs/global/threading.md](specs/global/threading.md) (v1.0):

- **Main Thread:** All GUI operations
- **Background Threads:** File indexing (`IndexWorker`)
...
Per [specs/global/error-handling.md](specs/global/error-handling.md) (v1.0):
...
- [File Association](specs/features/file-association.md)
- [Multi-Instance](specs/features/multi-window-instance.md)
- [Main Controller](specs/features/main-controller.md)
- [UI Components](specs/features/ui-components.md)
- [UI Design System](specs/features/ui-design-system.md)
- [Typography System](specs/features/typography-system.md)
- [Table Column Alignment](specs/features/table-column-alignment.md)
- [Table Cell Text Overflow](specs/features/table-cell-text-overflow.md)
- [Table Unified Styles](specs/features/table-unified-styles.md)
- [Selection Preservation](specs/features/selection-preservation.md)
...
|---------|------|---------|
| 1.6 | 2026-03-21 | Added multi-window instance feature for macOS/Windows |
| 1.5 | 2026-03-21 | Added file association feature for "Open with..." support |
| 1.4 | 2026-03-18 | Removed real-time file watching and auto-reload feature |
| 1.3 | 2026-03-15 | Fixed documentation validity: version sync, cross-references, removed duplicate content |
| 1.2 | 2026-03-15 | Synchronized with SPEC-INDEX.md: added 6 missing features, updated versions |
