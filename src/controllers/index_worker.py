"""Worker thread for building document index.

This module provides a QThread-based worker for indexing documents
...
class IndexWorker(QThread):
    ...
    def run(self) -> None:
        ...
        self._document.build_index(self._on_progress)
        self.finished.emit()
